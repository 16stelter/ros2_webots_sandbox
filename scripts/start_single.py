...
from ros2_webots_sandbox.webots_robot_controller import RobotController
...
if __name__ == "__main__":
    ...
    parser.add_argument('--robot_name', help="which robot should be started", default="leo1")
    parser.add_argument('--robot-type', help="which robot should be started", default="leo")
