...
class SupervisorController:
    def __init__(self, ros_node: Node = None, ros_active=False, mode='normal', base_ns='/', model_states_active=True, robot="leo"):
        """
    ...
    def reset_robot_init(self, name="leo1"):
        self.robot_nodes[name].loadState('__init__')
        self.robot_nodes[name].resetPhysics()

    def set_initial_poses(self, request=None, response=Empty.Response()):
        self.reset_robot_pose_rpy([-1, 3, self.reset_height], [0, 0.24, -1.57], name="leo1")
        self.reset_robot_pose_rpy([-1, -3, self.reset_height], [0, 0.24, 1.57], name="leo2")
        self.reset_robot_pose_rpy([-3, 3, self.reset_height], [0, 0.24, -1.57], name="belka")
        self.reset_robot_pose_rpy([-3, -3, self.reset_height], [0, 0.24, 1.57], name="strelka")
        return response
    ...
    def get_robot_orientation_quat(self, name="leo1"):
        ax_angle = self.get_robot_orientation_axangles(name)
    ...
    def get_link_velocities(self, link, name="leo1"):
